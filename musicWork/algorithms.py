...
def GeneticAlgorithm1(gaIndex:int):
...
def GeneticAlgorithm(gaIndex:int, populationSize:int, chromosomeLength:int, selectionIndex:int, crossoverIndex, numMutations:int, mutationProbability:int):
